...
/***************Intialize hardware macros for Actuators***************/
volatile int i=0;     //initializing a integer for incrementing and decrementing duty ratio.
#define LEDPIN  7     // This for coontrolling the light intensity 
#define Fanrelay 10   // This is for controling the Fan relay
...
void loop()
{
 ...
 /*****************Flame sensor part*****************************/
  ...
  else if (buffer == 'led_high')
   {
     analogWrite(LEDPIN, 255);
   }
  else if (buffer == 'FanOn')
   {
     digitalWrite(Fanrelay, HIGH);
   }
  else if (buffer == 'FanOFF')
  {
